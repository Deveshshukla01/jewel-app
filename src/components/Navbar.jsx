...
export default function Navbar() {
  ...
  const handleScrollTo = (id) => {
    ...
    if (target) {
      const headerOffset = 80 // adjust if navbar overlaps
              ...
              {isHomePage && (
                <>
                  ...
                  >
                   ...
                   {/* Gurmeena Store always visible */}
              <button
                onClick={() => handleScrollTo("gurmeena")}
