...
//   const itemsPerPage = window.innerWidth < 768 ? 4 : 16; // 4 for phone (2x2), 16 for desktop (4x4)
...
//                 >
//                   <div
//                     className="animate-spin rounded-full h-12 w-12 border-4 border-brown-200"
//                     style={{ borderTopColor: "#542018" }}
//                   ></div>
//                 </motion.div>
//               ) : (
...
//                              hover:bg-[#542018] hover:text-white"
//                 >
...
//       setPage(newPage);
//       setPageLoading(false);
//     }, 600); // allow pop-out + spinner + pop-in
//   };
