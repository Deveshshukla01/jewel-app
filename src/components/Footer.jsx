...
import { MdPhone, MdLocationOn, MdMailOutline } from "react-icons/md";
...
export default function Footer() {
  ...
  return (
    <footer
      id="footer"
      className="bg-gradient-to-b from-[#542018] to-[#3d1611] text-amber-100 mt-auto relative overflow-hidden font-serif"
    >
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-amber-300/70 text-sm font-medium tracking-wide">
                  Your reliable jewellery destination that makes you feel
                  special.
                </p>
              </div>
            </div>
            ...
            <nav className="space-y-3">
              {[
                ...
                <button
                  ...
                  className="block text-left w-full text-amber-200/80 hover:text-yellow-400 transition-all duration-300 text-base font-light group"
                >
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="space-y-4">
              {[
                {
                  icon: MdPhone,
                  href: "tel:+917973616115",
                  text: "+91 79736 16115",
                },
                {
                  icon: MdMailOutline,
                  href: "mailto:sethijewellers.100@gmail.com",
                  text: "sethijewellers.100@gmail.com",
                },
                {
                  icon: MdLocationOn,
