...
//     // 👇 Fix: always scroll to top when category changes
                ...
                <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-6">
                  {products.length === 0 ? (
                    ...
                    products.map((p) => (
                      <a
                        key={p.$id}
                        href={`https://wa.me/917973616115?text=Hi, I'm interested in the product: ${encodeURIComponent(
                          p.name || "Jewelry Item"
                        )}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="group bg-white rounded-3xl overflow-hidden shadow-warm hover:shadow-warm-lg card-hover stagger-item block"
                      >
                        <div className="relative overflow-hidden">
                          <img
                            src={
